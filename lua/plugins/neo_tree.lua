...
return {
  ...
  config = function()
    require("neo-tree").setup({
      -- Close Neo-tree when opening a file to improve performance
      ...
      filesystem = {
        ...
        bind_to_cwd = true, -- Enable proper cwd binding
        cwd_target = {
          sidebar = "tab", -- Use tab-specific cwd for sidebar
          current = "window", -- Use window-specific cwd for current file
        },

        hijack_netrw_behavior = "open_current",
        scan_mode = "shallow",

        -- Async directory scanning for better performance
      ...
      -- Performance optimization: reduce rendering frequency
      nesting_rules = {},
