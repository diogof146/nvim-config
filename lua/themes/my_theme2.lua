...
local theme = lush(function(injected_functions)
	...
	return {
		SpecialKey({ fg = "#007b8a" }), -- SpecialKey     xxx guifg=#007b8a
		EndOfBuffer({ fg = "#007b8a" }), -- EndOfBuffer    xxx guifg=#007b8a
		...
		NonText({ fg = "#6aa0b8" }), -- NonText        xxx guifg=#6aa0b8
		...
		Directory({ fg = "#45c8d1" }), -- Directory      xxx guifg=#45c8d1
		...
		ErrorMsg({ bg = "#2b1211", gui = "bold", fg = "#ff6b6b" }), -- ErrorMsg       xxx cterm=bold gui=bold guifg=#ff6b6b guibg=#2b1211
		NvimInvalidSpacing({ ErrorMsg }), -- NvimInvalidSpacing xxx links to ErrorMsg
		IncSearch({ bg = "#00f0ff", gui = "bold", fg = "#000000" }), -- IncSearch      xxx cterm=bold gui=bold guifg=#000000 guibg=#00f0ff
		Search({ bg = "#00a8ee", gui = "bold", fg = "#000000" }), -- Search         xxx cterm=bold gui=bold guifg=#000000 guibg=#00a8ee
		Substitute({ Search }), -- Substitute     xxx links to Search
		TelescopePreviewMatch({ Search }), -- TelescopePreviewMatch xxx links to Search
		CurSearch({ bg = "#b8f0ff", gui = "bold", fg = "#000000" }), -- CurSearch      xxx cterm=bold gui=bold guifg=#000000 guibg=#b8f0ff
		MoreMsg({ gui = "bold", fg = "#00c4d1" }), -- MoreMsg        xxx cterm=bold gui=bold guifg=#00c4d1
		ModeMsg({ gui = "bold", fg = "#00c4d1" }), -- ModeMsg        xxx cterm=bold gui=bold guifg=#00c4d1
		LineNr({ fg = "#007b8a" }), -- LineNr         xxx guifg=#007b8a
		...
		CursorLineNr({ gui = "bold", fg = "#00c4d1" }), -- CursorLineNr   xxx cterm=bold gui=bold guifg=#00c4d1
		DapUIBreakpointsCurrentLine({ CursorLineNr }), -- DapUIBreakpointsCurrentLine xxx links to CursorLineNr
		Question({ gui = "underline", fg = "#00c4d1" }), -- Question       xxx cterm=underline gui=underline guifg=#00c4d1
		StatusLine({ fg = "#00c4d1" }), -- StatusLine     xxx guifg=#00c4d1
		...
		VertSplit({ fg = "#007b8a" }), -- VertSplit      xxx guifg=#007b8a
		Title({ fg = "#8bf0ff" }), -- Title          xxx guifg=#8bf0ff
		...
		Visual({ bg = "#013540", gui = "bold" }), -- Visual         xxx cterm=bold gui=bold guibg=#007b8a
		...
		WarningMsg({ bg = "#102147", gui = "bold", fg = "#3e69e1" }), -- WarningMsg     xxx cterm=bold gui=bold guifg=#3e69e1 guibg=#102147
		sym("@lsp.type.namespace")({ fg = hsl("#199BE5") }),
		sym("@lsp.type.class")({ fg = hsl("#03C1CD") }),
		sym("@lsp.type.record")({ fg = hsl("#03C1CD") }),
		WildMenu({ fg = "#00f0ff" }), -- WildMenu       xxx guifg=#00f0ff
		Folded({ bg = "#1a1a1a", gui = "bold", fg = "#007b8a" }), -- Folded         xxx cterm=bold gui=bold guifg=#007b8a guibg=#1a1a1a
		FoldColumn({ gui = "bold", fg = "#007b8a" }), -- FoldColumn     xxx cterm=bold gui=bold guifg=#007b8a
		CursorLineFold({ FoldColumn }), -- CursorLineFold xxx links to FoldColumn
		DiffAdd({ bg = "#3dd8e0", fg = "#000000" }), -- DiffAdd        xxx guifg=#000000 guibg=#3dd8e0
		TelescopeResultsDiffAdd({ DiffAdd }), -- TelescopeResultsDiffAdd xxx links to DiffAdd
		DiffChange({ bg = "#00f0ff", fg = "#000000" }), -- DiffChange     xxx guifg=#000000 guibg=#00f0ff
		...
		DiffText({ bg = "#00f0ff", gui = "bold", fg = "#000000" }), -- DiffText       xxx cterm=bold gui=bold guifg=#000000 guibg=#00f0ff
		Conceal({ fg = "#00c4d1" }), -- Conceal        xxx guifg=#00c4d1
		SpellBad({ sp = "#ff6b6b", gui = "undercurl" }), -- SpellBad       xxx cterm=undercurl gui=undercurl guisp=#ff6b6b
		...
		Pmenu({ fg = "#00f0ff" }), -- Pmenu          xxx guifg=#00f0ff
		...
		PmenuSel({ bg = "#00f0ff", fg = "#000000" }), -- PmenuSel       xxx guifg=#000000 guibg=#00f0ff
		...
		ColorColumn({ bg = "#007b8a" }), -- ColorColumn    xxx guibg=#007b8a
		QuickFixLine({ fg = "nvimlightcyan" }), -- QuickFixLine   xxx ctermfg=14 guifg=NvimLightCyan
		Whitespace({ fg = "#6aa0b8" }), -- Whitespace     xxx guifg=#6aa0b8
		...
		FloatBorder({ fg = "#00c4d1" }), -- FloatBorder    xxx guifg=#00c4d1
		...
		WinBar({ fg = "#45c8d1" }), -- WinBar         xxx guifg=#45c8d1
		WinBarNC({ fg = "#6aa0b8" }), -- WinBarNC       xxx guifg=#6aa0b8
		Cursor({ bg = "#00f0ff", blend = 100, fg = "#000000" }), -- Cursor         xxx guifg=#000000 guibg=#00f0ff blend=100
		NoiceCursor({ Cursor }), -- NoiceCursor    xxx links to Cursor
		FloatTitle({ fg = "#00c4d1" }), -- FloatTitle     xxx guifg=#00c4d1
		...
		Underlined({ gui = "underline", fg = "#00c4d1" }), -- Underlined     xxx cterm=underline gui=underline guifg=#00c4d1
		...
		CursorIM({ bg = "#00c4d1" }), -- CursorIM       xxx guibg=#00c4d1
		...
		Constant({ fg = "#70f0d4" }), -- Constant       xxx guifg=#70f0d4
		...
		Number({ fg = "#00c8aa" }), -- Number         xxx guifg=#00c8aa
		...
		Statement({ fg = "#7de0e8" }), -- Statement      xxx guifg=#7de0e8
		...
		Include({ fg = "#00f0ff" }), -- Include        xxx guifg=#00f0ff
		PreProc({ fg = "#007b8a" }), -- PreProc        xxx guifg=#007b8a
		...
		Type({ fg = "#00c4d1" }), -- Type           xxx guifg=#00c4d1
		...
		Typedef({ fg = "#a8e0ff" }), -- Typedef        xxx guifg=#a8e0ff
		Special({ fg = "#8bf0ff" }), -- Special        xxx guifg=#8bf0ff
		...
		SpecialComment({ fg = "#4080b4" }), -- SpecialComment xxx guifg=#4080b4
		...
		String({ fg = "#b8f0ff" }), -- String         xxx guifg=#b8f0ff
		...
		Identifier({ fg = "#7ac8eb" }), -- Identifier     xxx guifg=#7ac8eb
		...
		Function({ fg = "#1ba8aa" }), -- Function       xxx guifg=#1ba8aa
		...
		Todo({ bg = "#2f4f4f", gui = "bold", fg = "#ffd700" }), -- Todo           xxx cterm=bold gui=bold guifg=#ffd700 guibg=#2f4f4f
		...
		MatchParen({ bg = "#585858", gui = "bold", fg = "#ffffff" }), -- MatchParen     xxx cterm=bold gui=bold guifg=#ffffff guibg=#585858
		...
		LspHintText({ fg = "#8bf0ff" }), -- LspHintText    xxx guifg=#8bf0ff
		...
		GitGutterChange({ gui = "bold", fg = "#6aa0b8" }), -- GitGutterChange xxx cterm=bold gui=bold guifg=#6aa0b8
		GitGutterAdd({ gui = "bold", fg = "#3dd8e0" }), -- GitGutterAdd   xxx cterm=bold gui=bold guifg=#3dd8e0
		CmpItemAbbrDefault({ fg = "#00f0ff" }), -- CmpItemAbbrDefault xxx guifg=#00f0ff
		...
		BufferLineTabSelected({ fg = "#00c4d1" }), -- BufferLineTabSelected xxx guifg=#00c4d1
		...
		BufferLineModified({ fg = "#b8f0ff" }), -- BufferLineModified xxx guifg=#b8f0ff
		...
		BufferLineIndicatorSelected({ fg = "#00c4d1" }), -- BufferLineIndicatorSelected xxx guifg=#00c4d1
		...
		BufferLineModifiedSelected({ fg = "#b8f0ff" }), -- BufferLineModifiedSelected xxx guifg=#b8f0ff
		BufferLineModifiedVisible({ fg = "#b8f0ff" }), -- BufferLineModifiedVisible xxx guifg=#b8f0ff
		BufferLineErrorDiagnosticSelected({ sp = "#bf908a", gui = "bold,italic", fg = "#bf908a" }), -- BufferLineErrorDiagnosticSelected xxx cterm=bold,italic gui=bold,italic guifg=#bf908a guisp=#bf908a
		...
		BufferLineErrorSelected({ sp = "#ffc0b9", gui = "bold,italic", fg = "#ffc0b9" }), -- BufferLineErrorSelected xxx cterm=bold,italic gui=bold,italic guifg=#ffc0b9 guisp=#ffc0b9
		BufferLineErrorVisible({ fg = "#6fa0a0" }), -- BufferLineErrorVisible xxx guifg=#6fa0a0
		BufferLineWarningDiagnosticSelected({ sp = "#bda86f", gui = "bold,italic", fg = "#bda86f" }), -- BufferLineWarningDiagnosticSelected xxx cterm=bold,italic gui=bold,italic guifg=#bda86f guisp=#bda86f
		...
		BufferLineWarningSelected({ sp = "#fce094", gui = "bold,italic", fg = "#fce094" }), -- BufferLineWarningSelected xxx cterm=bold,italic gui=bold,italic guifg=#fce094 guisp=#fce094
		...
		BufferLineInfoDiagnosticSelected({ sp = "#69bab9", gui = "bold,italic", fg = "#69bab9" }), -- BufferLineInfoDiagnosticSelected xxx cterm=bold,italic gui=bold,italic guifg=#69bab9 guisp=#69bab9
		...
		BufferLineInfoSelected({ sp = "#8cf8f7", gui = "bold,italic", fg = "#8cf8f7" }), -- BufferLineInfoSelected xxx cterm=bold,italic gui=bold,italic guifg=#8cf8f7 guisp=#8cf8f7
		BufferLineInfoVisible({ fg = "#6fa0a0" }), -- BufferLineInfoVisible xxx guifg=#6fa0a0
		BufferLineHintDiagnosticSelected({ sp = "#7ca4bf", gui = "bold,italic", fg = "#7ca4bf" }), -- BufferLineHintDiagnosticSelected xxx cterm=bold,italic gui=bold,italic guifg=#7ca4bf guisp=#7ca4bf
		...
		BufferLineHintSelected({ sp = "#a6dbff", gui = "bold,italic", fg = "#a6dbff" }), -- BufferLineHintSelected xxx cterm=bold,italic gui=bold,italic guifg=#a6dbff guisp=#a6dbff
		...
		lualine_a_replace({ bg = "#00c8aa", gui = "bold,nocombine", fg = "#000000" }), -- lualine_a_replace xxx gui=bold,nocombine guifg=#000000 guibg=#00c8aa
		lualine_b_replace({ bg = "#000000", gui = "nocombine", fg = "#00c8aa" }), -- lualine_b_replace xxx gui=nocombine guifg=#00c8aa guibg=#000000
		lualine_c_replace({ bg = "#000000", gui = "nocombine", fg = "#b0b0b0" }), -- lualine_c_replace xxx gui=nocombine guifg=#b0b0b0 guibg=#000000
		lualine_a_normal({ bg = "#00f0ff", gui = "bold,nocombine", fg = "#000000" }), -- lualine_a_normal xxx gui=bold,nocombine guifg=#000000 guibg=#00f0ff
		lualine_b_normal({ bg = "#000000", gui = "nocombine", fg = "#00f0ff" }), -- lualine_b_normal xxx gui=nocombine guifg=#00f0ff guibg=#000000
		lualine_c_normal({ bg = "#000000", gui = "nocombine", fg = "#b0b0b0" }), -- lualine_c_normal xxx gui=nocombine guifg=#b0b0b0 guibg=#000000
		lualine_a_inactive({ bg = "#00f0ff", gui = "bold,nocombine", fg = "#000000" }), -- lualine_a_inactive xxx gui=bold,nocombine guifg=#000000 guibg=#00f0ff
		lualine_b_inactive({ bg = "#000000", gui = "nocombine", fg = "#00f0ff" }), -- lualine_b_inactive xxx gui=nocombine guifg=#00f0ff guibg=#000000
		lualine_c_inactive({ bg = "#000000", gui = "nocombine", fg = "#b0b0b0" }), -- lualine_c_inactive xxx gui=nocombine guifg=#b0b0b0 guibg=#000000
		lualine_a_terminal({ bg = "#7ac8eb", gui = "bold,nocombine", fg = "#000000" }), -- lualine_a_terminal xxx gui=bold,nocombine guifg=#000000 guibg=#7ac8eb
		lualine_b_terminal({ bg = "#000000", gui = "nocombine", fg = "#7ac8eb" }), -- lualine_b_terminal xxx gui=nocombine guifg=#7ac8eb guibg=#000000
		lualine_c_terminal({ bg = "#000000", gui = "nocombine", fg = "#b0b0b0" }), -- lualine_c_terminal xxx gui=nocombine guifg=#b0b0b0 guibg=#000000
		lualine_a_command({ bg = "#7ac8eb", gui = "bold,nocombine", fg = "#000000" }), -- lualine_a_command xxx gui=bold,nocombine guifg=#000000 guibg=#7ac8eb
		lualine_b_command({ bg = "#000000", gui = "nocombine", fg = "#7ac8eb" }), -- lualine_b_command xxx gui=nocombine guifg=#7ac8eb guibg=#000000
		lualine_c_command({ bg = "#000000", gui = "nocombine", fg = "#b0b0b0" }), -- lualine_c_command xxx gui=nocombine guifg=#b0b0b0 guibg=#000000
		lualine_a_visual({ bg = "#8bf0ff", gui = "bold,nocombine", fg = "#000000" }), -- lualine_a_visual xxx gui=bold,nocombine guifg=#000000 guibg=#8bf0ff
		lualine_b_visual({ bg = "#000000", gui = "nocombine", fg = "#8bf0ff" }), -- lualine_b_visual xxx gui=nocombine guifg=#8bf0ff guibg=#000000
		lualine_c_visual({ bg = "#000000", gui = "nocombine", fg = "#b0b0b0" }), -- lualine_c_visual xxx gui=nocombine guifg=#b0b0b0 guibg=#000000
		lualine_a_insert({ bg = "#b8f0ff", gui = "bold,nocombine", fg = "#000000" }), -- lualine_a_insert xxx gui=bold,nocombine guifg=#000000 guibg=#b8f0ff
		lualine_b_insert({ bg = "#000000", gui = "nocombine", fg = "#b8f0ff" }), -- lualine_b_insert xxx gui=nocombine guifg=#b8f0ff guibg=#000000
		lualine_c_insert({ bg = "#000000", gui = "nocombine", fg = "#b0b0b0" }), -- lualine_c_insert xxx gui=nocombine guifg=#b0b0b0 guibg=#000000
		lualine_b_branch_normal({ bg = "#000000", gui = "nocombine", fg = "#40e0d0" }), -- lualine_b_branch_normal xxx gui=nocombine guifg=#40e0d0 guibg=#000000
		lualine_b_branch_insert({ bg = "#000000", gui = "nocombine", fg = "#40e0d0" }), -- lualine_b_branch_insert xxx gui=nocombine guifg=#40e0d0 guibg=#000000
		lualine_b_branch_visual({ bg = "#000000", gui = "nocombine", fg = "#40e0d0" }), -- lualine_b_branch_visual xxx gui=nocombine guifg=#40e0d0 guibg=#000000
		lualine_b_branch_replace({ bg = "#000000", gui = "nocombine", fg = "#40e0d0" }), -- lualine_b_branch_replace xxx gui=nocombine guifg=#40e0d0 guibg=#000000
		lualine_b_branch_command({ bg = "#000000", gui = "nocombine", fg = "#40e0d0" }), -- lualine_b_branch_command xxx gui=nocombine guifg=#40e0d0 guibg=#000000
		lualine_b_branch_terminal({ bg = "#000000", gui = "nocombine", fg = "#40e0d0" }), -- lualine_b_branch_terminal xxx gui=nocombine guifg=#40e0d0 guibg=#000000
		lualine_b_branch_inactive({ bg = "#000000", gui = "nocombine", fg = "#40e0d0" }), -- lualine_b_branch_inactive xxx gui=nocombine guifg=#40e0d0 guibg=#000000
		lualine_b_diff_added_normal({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_b_diff_added_normal xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_b_diff_added_insert({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_b_diff_added_insert xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_b_diff_added_visual({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_b_diff_added_visual xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_b_diff_added_replace({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_b_diff_added_replace xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_b_diff_added_command({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_b_diff_added_command xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_b_diff_added_terminal({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_b_diff_added_terminal xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_b_diff_added_inactive({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_b_diff_added_inactive xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_b_diff_modified_normal({ bg = "#000000", gui = "nocombine", fg = "#48d1cc" }), -- lualine_b_diff_modified_normal xxx gui=nocombine guifg=#48d1cc guibg=#000000
		lualine_b_diff_modified_insert({ bg = "#000000", gui = "nocombine", fg = "#48d1cc" }), -- lualine_b_diff_modified_insert xxx gui=nocombine guifg=#48d1cc guibg=#000000
		lualine_b_diff_modified_visual({ bg = "#000000", gui = "nocombine", fg = "#48d1cc" }), -- lualine_b_diff_modified_visual xxx gui=nocombine guifg=#48d1cc guibg=#000000
		lualine_b_diff_modified_replace({ bg = "#000000", gui = "nocombine", fg = "#48d1cc" }), -- lualine_b_diff_modified_replace xxx gui=nocombine guifg=#48d1cc guibg=#000000
		lualine_b_diff_modified_command({ bg = "#000000", gui = "nocombine", fg = "#48d1cc" }), -- lualine_b_diff_modified_command xxx gui=nocombine guifg=#48d1cc guibg=#000000
		lualine_b_diff_modified_terminal({ bg = "#000000", gui = "nocombine", fg = "#48d1cc" }), -- lualine_b_diff_modified_terminal xxx gui=nocombine guifg=#48d1cc guibg=#000000
		lualine_b_diff_modified_inactive({ bg = "#000000", gui = "nocombine", fg = "#48d1cc" }), -- lualine_b_diff_modified_inactive xxx gui=nocombine guifg=#48d1cc guibg=#000000
		lualine_b_diff_removed_normal({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_b_diff_removed_normal xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_b_diff_removed_insert({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_b_diff_removed_insert xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_b_diff_removed_visual({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_b_diff_removed_visual xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_b_diff_removed_replace({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_b_diff_removed_replace xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_b_diff_removed_command({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_b_diff_removed_command xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_b_diff_removed_terminal({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_b_diff_removed_terminal xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_b_diff_removed_inactive({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_b_diff_removed_inactive xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_x_diagnostics_error_normal({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_x_diagnostics_error_normal xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_x_diagnostics_error_insert({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_x_diagnostics_error_insert xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_x_diagnostics_error_visual({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_x_diagnostics_error_visual xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_x_diagnostics_error_replace({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_x_diagnostics_error_replace xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_x_diagnostics_error_command({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_x_diagnostics_error_command xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_x_diagnostics_error_terminal({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_x_diagnostics_error_terminal xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_x_diagnostics_error_inactive({ bg = "#000000", gui = "nocombine", fg = "#ff6b6b" }), -- lualine_x_diagnostics_error_inactive xxx gui=nocombine guifg=#ff6b6b guibg=#000000
		lualine_x_diagnostics_warn_normal({ bg = "#000000", gui = "nocombine", fg = "#87ceeb" }), -- lualine_x_diagnostics_warn_normal xxx gui=nocombine guifg=#87ceeb guibg=#000000
		lualine_x_diagnostics_warn_insert({ bg = "#000000", gui = "nocombine", fg = "#87ceeb" }), -- lualine_x_diagnostics_warn_insert xxx gui=nocombine guifg=#87ceeb guibg=#000000
		lualine_x_diagnostics_warn_visual({ bg = "#000000", gui = "nocombine", fg = "#87ceeb" }), -- lualine_x_diagnostics_warn_visual xxx gui=nocombine guifg=#87ceeb guibg=#000000
		lualine_x_diagnostics_warn_replace({ bg = "#000000", gui = "nocombine", fg = "#87ceeb" }), -- lualine_x_diagnostics_warn_replace xxx gui=nocombine guifg=#87ceeb guibg=#000000
		lualine_x_diagnostics_warn_command({ bg = "#000000", gui = "nocombine", fg = "#87ceeb" }), -- lualine_x_diagnostics_warn_command xxx gui=nocombine guifg=#87ceeb guibg=#000000
		lualine_x_diagnostics_warn_terminal({ bg = "#000000", gui = "nocombine", fg = "#87ceeb" }), -- lualine_x_diagnostics_warn_terminal xxx gui=nocombine guifg=#87ceeb guibg=#000000
		lualine_x_diagnostics_warn_inactive({ bg = "#000000", gui = "nocombine", fg = "#87ceeb" }), -- lualine_x_diagnostics_warn_inactive xxx gui=nocombine guifg=#87ceeb guibg=#000000
		lualine_x_diagnostics_info_normal({ bg = "#000000", gui = "nocombine", fg = "#98f5ff" }), -- lualine_x_diagnostics_info_normal xxx gui=nocombine guifg=#98f5ff guibg=#000000
		lualine_x_diagnostics_info_insert({ bg = "#000000", gui = "nocombine", fg = "#98f5ff" }), -- lualine_x_diagnostics_info_insert xxx gui=nocombine guifg=#98f5ff guibg=#000000
		lualine_x_diagnostics_info_visual({ bg = "#000000", gui = "nocombine", fg = "#98f5ff" }), -- lualine_x_diagnostics_info_visual xxx gui=nocombine guifg=#98f5ff guibg=#000000
		lualine_x_diagnostics_info_replace({ bg = "#000000", gui = "nocombine", fg = "#98f5ff" }), -- lualine_x_diagnostics_info_replace xxx gui=nocombine guifg=#98f5ff guibg=#000000
		lualine_x_diagnostics_info_command({ bg = "#000000", gui = "nocombine", fg = "#98f5ff" }), -- lualine_x_diagnostics_info_command xxx gui=nocombine guifg=#98f5ff guibg=#000000
		lualine_x_diagnostics_info_terminal({ bg = "#000000", gui = "nocombine", fg = "#98f5ff" }), -- lualine_x_diagnostics_info_terminal xxx gui=nocombine guifg=#98f5ff guibg=#000000
		lualine_x_diagnostics_info_inactive({ bg = "#000000", gui = "nocombine", fg = "#98f5ff" }), -- lualine_x_diagnostics_info_inactive xxx gui=nocombine guifg=#98f5ff guibg=#000000
		lualine_x_diagnostics_hint_normal({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_x_diagnostics_hint_normal xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_x_diagnostics_hint_insert({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_x_diagnostics_hint_insert xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_x_diagnostics_hint_visual({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_x_diagnostics_hint_visual xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_x_diagnostics_hint_replace({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_x_diagnostics_hint_replace xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_x_diagnostics_hint_command({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_x_diagnostics_hint_command xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_x_diagnostics_hint_terminal({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_x_diagnostics_hint_terminal xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_x_diagnostics_hint_inactive({ bg = "#000000", gui = "nocombine", fg = "#00ced1" }), -- lualine_x_diagnostics_hint_inactive xxx gui=nocombine guifg=#00ced1 guibg=#000000
		lualine_x_filetype_normal({ bg = "#000000", gui = "nocombine", fg = "#00ffff" }), -- lualine_x_filetype_normal xxx gui=nocombine guifg=#00ffff guibg=#000000
		lualine_x_filetype_insert({ bg = "#000000", gui = "nocombine", fg = "#00ffff" }), -- lualine_x_filetype_insert xxx gui=nocombine guifg=#00ffff guibg=#000000
		lualine_x_filetype_visual({ bg = "#000000", gui = "nocombine", fg = "#00ffff" }), -- lualine_x_filetype_visual xxx gui=nocombine guifg=#00ffff guibg=#000000
		lualine_x_filetype_replace({ bg = "#000000", gui = "nocombine", fg = "#00ffff" }), -- lualine_x_filetype_replace xxx gui=nocombine guifg=#00ffff guibg=#000000
		lualine_x_filetype_command({ bg = "#000000", gui = "nocombine", fg = "#00ffff" }), -- lualine_x_filetype_command xxx gui=nocombine guifg=#00ffff guibg=#000000
		lualine_x_filetype_terminal({ bg = "#000000", gui = "nocombine", fg = "#00ffff" }), -- lualine_x_filetype_terminal xxx gui=nocombine guifg=#00ffff guibg=#000000
		lualine_x_filetype_inactive({ bg = "#000000", gui = "nocombine", fg = "#00ffff" }), -- lualine_x_filetype_inactive xxx gui=nocombine guifg=#00ffff guibg=#000000
		lualine_c_6_normal({ bg = "#000000", gui = "nocombine", fg = "#b0e2ff" }), -- lualine_c_6_normal xxx gui=nocombine guifg=#b0e2ff guibg=#000000
		lualine_c_6_insert({ bg = "#000000", gui = "nocombine", fg = "#b0e2ff" }), -- lualine_c_6_insert xxx gui=nocombine guifg=#b0e2ff guibg=#000000
		lualine_c_6_visual({ bg = "#000000", gui = "nocombine", fg = "#b0e2ff" }), -- lualine_c_6_visual xxx gui=nocombine guifg=#b0e2ff guibg=#000000
		lualine_c_6_replace({ bg = "#000000", gui = "nocombine", fg = "#b0e2ff" }), -- lualine_c_6_replace xxx gui=nocombine guifg=#b0e2ff guibg=#000000
		lualine_c_6_command({ bg = "#000000", gui = "nocombine", fg = "#b0e2ff" }), -- lualine_c_6_command xxx gui=nocombine guifg=#b0e2ff guibg=#000000
		lualine_c_6_terminal({ bg = "#000000", gui = "nocombine", fg = "#b0e2ff" }), -- lualine_c_6_terminal xxx gui=nocombine guifg=#b0e2ff guibg=#000000
		lualine_c_6_inactive({ bg = "#000000", gui = "nocombine", fg = "#b0e2ff" }), -- lualine_c_6_inactive xxx gui=nocombine guifg=#b0e2ff guibg=#000000
		lualine_z_location_normal({ bg = "#00f0ff", gui = "nocombine", fg = "#000000" }), -- lualine_z_location_normal xxx gui=nocombine guifg=#000000 guibg=#00f0ff
		lualine_z_location_insert({ bg = "#b8f0ff", gui = "nocombine", fg = "#000000" }), -- lualine_z_location_insert xxx gui=nocombine guifg=#000000 guibg=#b8f0ff
		lualine_z_location_visual({ bg = "#8bf0ff", gui = "nocombine", fg = "#000000" }), -- lualine_z_location_visual xxx gui=nocombine guifg=#000000 guibg=#8bf0ff
		lualine_z_location_replace({ bg = "#00c8aa", gui = "nocombine", fg = "#000000" }), -- lualine_z_location_replace xxx gui=nocombine guifg=#000000 guibg=#00c8aa
		lualine_z_location_command({ bg = "#7ac8eb", gui = "nocombine", fg = "#000000" }), -- lualine_z_location_command xxx gui=nocombine guifg=#000000 guibg=#7ac8eb
		lualine_z_location_terminal({ bg = "#7ac8eb", gui = "nocombine", fg = "#000000" }), -- lualine_z_location_terminal xxx gui=nocombine guifg=#000000 guibg=#7ac8eb
		lualine_z_location_inactive({ bg = "#00f0ff", gui = "nocombine", fg = "#000000" }), -- lualine_z_location_inactive xxx gui=nocombine guifg=#000000 guibg=#00f0ff
		lualine_y_progress_normal({ bg = "#000000", gui = "nocombine", fg = "#6ca6a8" }), -- lualine_y_progress_normal xxx gui=nocombine guifg=#6ca6a8 guibg=#000000
		lualine_y_progress_insert({ bg = "#000000", gui = "nocombine", fg = "#6ca6a8" }), -- lualine_y_progress_insert xxx gui=nocombine guifg=#6ca6a8 guibg=#000000
		lualine_y_progress_visual({ bg = "#000000", gui = "nocombine", fg = "#6ca6a8" }), -- lualine_y_progress_visual xxx gui=nocombine guifg=#6ca6a8 guibg=#000000
		lualine_y_progress_replace({ bg = "#000000", gui = "nocombine", fg = "#6ca6a8" }), -- lualine_y_progress_replace xxx gui=nocombine guifg=#6ca6a8 guibg=#000000
		lualine_y_progress_command({ bg = "#000000", gui = "nocombine", fg = "#6ca6a8" }), -- lualine_y_progress_command xxx gui=nocombine guifg=#6ca6a8 guibg=#000000
		lualine_y_progress_terminal({ bg = "#000000", gui = "nocombine", fg = "#6ca6a8" }), -- lualine_y_progress_terminal xxx gui=nocombine guifg=#6ca6a8 guibg=#000000
		lualine_y_progress_inactive({ bg = "#000000", gui = "nocombine", fg = "#6ca6a8" }), -- lualine_y_progress_inactive xxx gui=nocombine guifg=#6ca6a8 guibg=#000000
		lualine_x_location_normal({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_x_location_normal xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_x_location_insert({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_x_location_insert xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_x_location_visual({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_x_location_visual xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_x_location_replace({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_x_location_replace xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_x_location_command({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_x_location_command xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_x_location_terminal({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_x_location_terminal xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_x_location_inactive({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_x_location_inactive xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_c_11_normal({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_c_11_normal xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_c_11_insert({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_c_11_insert xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_c_11_visual({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_c_11_visual xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_c_11_replace({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_c_11_replace xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_c_11_command({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_c_11_command xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_c_11_terminal({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_c_11_terminal xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		lualine_c_11_inactive({ bg = "#000000", gui = "nocombine", fg = "#8b8b8b" }), -- lualine_c_11_inactive xxx gui=nocombine guifg=#8b8b8b guibg=#000000
		NeoscrollHiddenCursor({ blend = 100, gui = "reverse" }), -- NeoscrollHiddenCursor xxx cterm=reverse gui=reverse blend=100
		...
		TinyInlineInvDiagnosticVirtualTextInfo({ bg = "#052459", fg = "#1f3736" }), -- TinyInlineInvDiagnosticVirtualTextInfo xxx guifg=#1f3736 guibg=#052459
		...
		TinyInlineInvDiagnosticVirtualTextHint({ bg = "#052459", fg = "#253038" }), -- TinyInlineInvDiagnosticVirtualTextHint xxx guifg=#253038 guibg=#052459
		...
		TinyInlineDiagnosticVirtualTextArrowNoBg({ fg = "#6aa0b8" }), -- TinyInlineDiagnosticVirtualTextArrowNoBg xxx guifg=#6aa0b8
		TinyInlineDiagnosticVirtualTextArrow({ bg = "#052459", fg = "#6aa0b8" }), -- TinyInlineDiagnosticVirtualTextArrow xxx guifg=#6aa0b8 guibg=#052459
		TinyInlineDiagnosticVirtualTextBg({ bg = "#052459" }), -- TinyInlineDiagnosticVirtualTextBg xxx guibg=#052459
		...
		TinyInlineInvDiagnosticVirtualTextError({ bg = "#052459", fg = "#382a29" }), -- TinyInlineInvDiagnosticVirtualTextError xxx guifg=#382a29 guibg=#052459
		...
		TinyInlineInvDiagnosticVirtualTextWarn({ bg = "#052459", fg = "#373121" }), -- TinyInlineInvDiagnosticVirtualTextWarn xxx guifg=#373121 guibg=#052459
		...
		NoiceFormatProgressDone({ bg = "#00a8ee", gui = "bold", fg = "#000000" }), -- NoiceFormatProgressDone xxx cterm=bold gui=bold guifg=#000000 guibg=#00a8ee
		...
		lualine_x_filetype_DevIconDefault_normal({ bg = "#000000", gui = "nocombine", fg = "#6d8086" }), -- lualine_x_filetype_DevIconDefault_normal xxx gui=nocombine guifg=#6d8086 guibg=#000000
		lualine_x_filetype_DevIconDefault_insert({ bg = "#000000", gui = "nocombine", fg = "#6d8086" }), -- lualine_x_filetype_DevIconDefault_insert xxx gui=nocombine guifg=#6d8086 guibg=#000000
		lualine_x_filetype_DevIconDefault_visual({ bg = "#000000", gui = "nocombine", fg = "#6d8086" }), -- lualine_x_filetype_DevIconDefault_visual xxx gui=nocombine guifg=#6d8086 guibg=#000000
		lualine_x_filetype_DevIconDefault_replace({ bg = "#000000", gui = "nocombine", fg = "#6d8086" }), -- lualine_x_filetype_DevIconDefault_replace xxx gui=nocombine guifg=#6d8086 guibg=#000000
		lualine_x_filetype_DevIconDefault_command({ bg = "#000000", gui = "nocombine", fg = "#6d8086" }), -- lualine_x_filetype_DevIconDefault_command xxx gui=nocombine guifg=#6d8086 guibg=#000000
		lualine_x_filetype_DevIconDefault_terminal({ bg = "#000000", gui = "nocombine", fg = "#6d8086" }), -- lualine_x_filetype_DevIconDefault_terminal xxx gui=nocombine guifg=#6d8086 guibg=#000000
		lualine_x_filetype_DevIconDefault_inactive({ bg = "#000000", gui = "nocombine", fg = "#6d8086" }), -- lualine_x_filetype_DevIconDefault_inactive xxx gui=nocombine guifg=#6d8086 guibg=#000000
	}
end)
return theme
